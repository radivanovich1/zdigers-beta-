                    ...
                    public void onItemClick(int id) {
                        ...
                        switch (id) {
                            ...
                            case R.id.my_zdigers:
                                ...
                                break;
                            case R.id.brb:
                                 intent1 = new Intent(ApplicationName.getAppContext(),ZdigerActivity.class);
                                intent1.putExtra("cat", "Big Russian Boss");
                                startActivity(intent1);
                                break;
                            case R.id.shur:
                                intent1 = new Intent(ApplicationName.getAppContext(),ZdigerActivity.class);
                                intent1.putExtra("cat", "Шурыгина");
                                startActivity(intent1);
                                break;
                            case R.id.hovan:
                                intent1 = new Intent(ApplicationName.getAppContext(),ZdigerActivity.class);
                                intent1.putExtra("cat", "Хованский");
                                startActivity(intent1);
                                break;
                            case R.id.larin:
                                intent1 = new Intent(ApplicationName.getAppContext(),ZdigerActivity.class);
                                intent1.putExtra("cat", "Ларин");
                                startActivity(intent1);
                                break;
                            case R.id.tix:
                                intent1 = new Intent(ApplicationName.getAppContext(),ZdigerActivity.class);
                                intent1.putExtra("cat", "This is Хорошо");
                                startActivity(intent1);
                                break;
                            case R.id.druj:
                                intent1 = new Intent(ApplicationName.getAppContext(),ZdigerActivity.class);
                                intent1.putExtra("cat", "Сергей Дружко");
                                startActivity(intent1);
                                break;
                            case R.id.ig:
                                intent1 = new Intent(ApplicationName.getAppContext(),ZdigerActivity.class);
                                intent1.putExtra("cat", "Ивангай");
                                startActivity(intent1);
                                break;
                        }
                        dialog.dismiss();
